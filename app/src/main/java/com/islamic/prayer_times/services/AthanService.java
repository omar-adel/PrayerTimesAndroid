...
package com.islamic.prayer_times.services;
...
import com.islamic.prayer_times.helpers.NotificationUtils;
import com.islamic.prayer_times.helpers.PrayerTimes;
...
import static com.islamic.prayer_times.helpers.NotificationUtils.ANDROID_CHANNEL_ID;
...
{
    public static final String EXTRA_PRAYER = "com.islamic.prayer_times.PRAYER";
    public static final String EXTRA_MUEZZIN = "com.islamic.prayer_times.MUEZZIN";
    public static final int ATHAN_DURATION= 6 * 60 * 1000;          // longest audio is 5' 10''

    public static final String ACTION_NOTIFY_ATHAN = "com.islamic.prayer_times.action.NOTIFY_ATHAN";
    public static final String ACTION_PLAY_ATHAN = "com.islamic.prayer_times.action.PLAY_ATHAN";
    public static final String ACTION_STOP_ATHAN = "com.islamic.prayer_times.action.STOP_ATHAN";
...
//                mAudioPlayer.setWakeMode(this, PowerManager.PARTIAL_WAKE_LOCK);
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        if (mNotificationBuilder != null && isForeground) {
            ...
            notificationUtils.getManager().notify(mNotificationId, mNotificationBuilder.build());
        }
    }
